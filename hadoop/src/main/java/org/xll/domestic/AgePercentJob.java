...
public class AgePercentJob {
  public static class AgePercentMapper extends Mapper<LongWritable, Text, Text, IntWritable> {
    // 输出的 key
  ...
  public static class AgePercentReducer extends Reducer<Text, IntWritable, Text, IntWritable> {
    // 输出的 value
  ...
  public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
    ...
    job.setCombinerClass(AgePercentReducer.class);
    // 指定当前Job的 Reducer
    job.setReducerClass(AgePercentReducer.class);
    ...
    Path dst = new Path("/domestic/age");
