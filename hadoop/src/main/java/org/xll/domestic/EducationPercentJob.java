...
public class EducationPercentJob {
  public static class EducationPercentMapper extends Mapper<LongWritable, Text, Text, IntWritable> {
    // 输出的 key
  ...
  public static class EducationPercentReducer extends Reducer<Text, IntWritable, Text, IntWritable> {
    // 输出的 value
  ...
  public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
    ...
    // 指定当前Job的 Mapper
    job.setMapperClass(EducationPercentMapper.class);
    // 指定当前Job的 Combiner 注意：一定不能影响最终计算结果 否则 不使用
    job.setCombinerClass(EducationPercentReducer.class);
    // 指定当前Job的 Reducer
    job.setReducerClass(EducationPercentReducer.class);
    ...
    Path dst = new Path("/domestic/education");
